<template>
    ...
    <div class="modal-mask" v-if="isFetch">
               ...
               <div class="card_form text-start w-[50%] m-auto p-5">
                   ...
                   <div class="flex w-[100%]">
                       ...
                       <div class="w-[50%] mt-2">
                           ...
                           <small v-show="firstname.length <= 0 && submit" style="color:red" >Please enter your first name</small>
                       </div>
                       <div class="w-[50%] mt-2">
                           ...
                           <small v-show="lastname.length <= 0 && submit" style="color:red">Please enter your last name</small>
                       </div>
                   </div>
                   <div class="flex w-[100%] mt-2">
                       <div class="w-[50%]">
                           ...
                           <small v-show="gender.length <= 0 && submit" style="color:red">Please select your gender</small>
                       </div>
                       <div class="w-[50%]">
                           ...
                           <div>
                               <select  id="batch" class="w-[97%] p-1.5 mt-1 text-slate-500 outline-blue-500 border-solid border-[1px] border-gray-400 text-sm" v-model="generation">
                                   <option  v-for = "batch in getBatchs" :key="batch" :value="batch.id">{{batch.generation}}</option>
                               </select>    
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="flex w-[100%]">
                           <div class="w-[50%] ">
                               ...
                               <small v-show="email.length <= 0 && submit" style="color:red" >Please enter your first email address</small>
                           </div>
                           <div class="w-[50%] ">
                               ...
                               <small v-show="phone.length <= 0 && submit" style="color:red" >Please enter your first phone number</small>
                           </div>
                       </div>
   ...
   export default {
       ...
       methods:{
           ...
           editinfo(){
               ...
               axios.post('/alumni/'+this.batchid,{ generation:this.generation}).then((response) =>{
                   return (response.data);
               })
