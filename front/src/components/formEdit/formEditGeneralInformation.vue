<template>
  <div class="about">
    <button @click="togle" class="bg-teal-500/80 p-1 rounded-xl w-[13%] text-white mt-2 mb-0">Edit</button>
          ...
          <form @submit.prevent="editInfo">  
              <div class="card_form text-start w-[50%] m-auto p-5">
                ...
                <div class="flex justify-between items-start text-sky-500/80 font-bold">
                  ...
                  <!-- cencel icon -->
                  <div class="w-[4%]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-Width={1.5} stroke="currentColor" className="w-6 h-6" @click="togle" >
                ...
                <div class="flex mt-4 ">
                  ...
                  <div class="overflow-y-auto h-[400px]">
                    <div class="w-[100%] mt-4">
                        ...
                        <br>
                        <input type="text" class="w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400" placeholder="e.g. Sophiem">
                    </div>
                    <div class="w-[100%] mt-2">
                        <label for="Last name" class="text-slate-500 text-sm">Last name</label> <sup class="star text-blue-500">*</sup> 
                        <br>
                        <input type="text" class="w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400" placeholder="e.g. Loem">
                    </div>
                  
                    <div class="w-[100%] mt-2">
                        <label for="Gender" class="text-slate-500 text-sm">Gender</label><sup class="star text-blue-500">*</sup> 
                        <br>
                        <select id="gender" class="w-[97%] p-1.5 mt-1 text-slate-500 outline-blue-500 border-solid border-[1px] border-gray-400 text-sm">
                          <option value="Male">Male</option>
                          <option value="Female">Female</option>
                        </select>
                    </div>
                    <h3 class="mt-7 text-slate-500 text-sm">Current position</h3>
                    <div class="w-[100%] mt-1">
                      <label for="position" class="text-slate-500 text-sm">Position</label> <sup class="star text-blue-500">*</sup> 
                      <br>
                      <input type="text" class="w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400 text-sm" placeholder="e.g. web developer">
                    </div>
                    <div class="w-[100%] mt-2">
                      <label for="company" class="text-slate-500 text-sm">Company</label> <sup class="star text-blue-500">*</sup> 
                      <br>
                      <input type="text" class="text-sm w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400" placeholder="e.g. ZINation">
                    </div>
                    ...
                    <div class="w-[100%] mt-1">
                      ...
                      <br>
                      <select id="batch" class="w-[97%] p-1.5 mt-1 text-slate-500 outline-blue-500 border-solid border-[1px] border-gray-400 text-sm">
                    ...
                    <div class="w-[100%] mt-1">
                      ...
                      <br>
                      <input type="email" class="text-sm w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400" placeholder="e.g. example@email.com">
                    </div>
                    <div class="w-[100%] mt-2">
                      <label for="company" class='text-slate-500 text-sm' >Phone</label> <sup class="star text-blue-500">*</sup> 
                      <br>
                      <input type="number" class="text-sm w-[97%] p-1 mt-1 outline-blue-500 border-solid border-[1px] border-gray-400" placeholder="e.g. 087 276 083">
                    </div>
